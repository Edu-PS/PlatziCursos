...
/*
Documento para realizar el dibujo en canvas con dos teclas pulsadas al mismo tiempo.

FUNCIONA:
  1) Cuando se pulsan dos teclas.
  2) Se puede seleccionar y cambiar color y "Lapiz" (Raton y Flechas).
  3) El dibujar con el raton.

FALTA:
  1) Cuando se presionan tres teclas no detecta la tercera tecla.
  2) Con dos teclas, cuando se suelta la ultima tecla pulsada no continua dibujando.
  3) Detectar los limites para avisar que se salio del canvas. (Flechas y Raton)
*/
